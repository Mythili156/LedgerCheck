...
import { User, Mail, Lock, Globe, ChevronDown, Hexagon, ArrowLeft } from 'lucide-react';
                ...
                <Card className="border-slate-200 shadow-2xl bg-white/80 backdrop-blur-md">
                    <CardContent className="p-8">
                        <div className="mb-6 text-center">
                            <h2 className="text-2xl font-bold text-slate-800">{t('registerTitle')}</h2>
                            <p className="text-sm text-slate-500 mt-2">{t('authSubtitle')}</p>
                            {error && (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all transform active:scale-[0.98] disabled:opacity-50"
                            >
                        ...
                        <div className="mt-6 text-center">
                            <Link to="/login" className="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors flex items-center justify-center gap-2">
                                <ArrowLeft size={16} />
                                {t('switchToLogin')}
                            </Link>
                        </div>
